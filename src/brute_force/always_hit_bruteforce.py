...
class AlwaysHitBruteForce:
    def __init__(self):
        self.create_deck()
        self.simluation_amount = 10

    def set_simulation_amount(self):
        self.simluation_amount = BruteForceSettings['Simulation Amount']
    ...
    def simulate_game(self, player_hand, dealer_hand, deck):
        while player_hand.get_value() <= BruteForceSettings['Threshold']:
    ...
    def output_results(self):
        ...
        i = 0
        while (i < self.simluation_amount):
